# From: https://github.com/aiff22/PyNET-PyTorch/blob/master/model.py
...
class PyNET(nn.Module):
    ...
    def __init__(self, level=1, instance_norm=True, instance_norm_level_1=False, input_channels=3):
        super(PyNET, self).__init__()

        self.level = level

        self.conv_l1_d1 = ConvMultiBlock(input_channels, 32, 3, instance_norm=False)
